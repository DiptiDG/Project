...
namespace ScheduleIt2._0.Controllers
{
    public class TimeOffEventController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]//passing requeststatus here in create function which open db class for us.
        public ActionResult Create([Bind(Include = "EventId,StartTime,EndTime,Message, RequestStatus, Title,AdminId")] TimeOffEvent timeOffEvent)
        {
